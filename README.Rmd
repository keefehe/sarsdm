...
- [`R/`](https://github.com/keefehe/sarsdm/tree/master/R):
...
Launch the [`make.R`](https://github.com/keefehe/sarsdm/tree/master/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/keefehe/sarsdm/blob/main/CONTRIBUTING.md).
